...
const Hero = () => {
  ...
  return (
    <section
      id="hero"
      ref={heroRef}
      className="min-h-screen flex items-center justify-center section-padding pt-32 bg-white"
    >
      <div className="container-max">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            >
              Hi, I'm <span className="text-sky-600">Andres</span>
            </h1>
            ...
            >
              ...
              <button className="btn-secondary group">
                Download CV
                <svg
                  className="w-5 h-5 ml-2 inline-block group-hover:translate-y-1 transition-transform"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
          ...
          <div className="flex justify-center lg:justify-end">
            <div ref={imageRef} className="relative w-80 h-80 lg:w-96 lg:h-96">
