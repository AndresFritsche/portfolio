...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "A modern real estate listing platform with advanced search filters, virtual tours, and mortgage calculator integration.",
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="card h-full hover:shadow-soft-lg transition-all duration-300">
                {/* Project Image/Icon */}
                <div className={`w-full h-48 bg-gradient-to-br ${project.color} rounded-xl mb-6 flex items-center justify-center text-6xl`}>
                  {project.image}
                </div>
